...
const calculateOfflineProgress = async (user) => {
  ...
  if (today > lastReset) { user.free_energy_refills = 3; user.ad_energy_left = 3; user.ad_x5_left = 3; user.ad_autoclick_left = 3; user.ad_magnet_left = 3; user.last_boost_reset = now; }
