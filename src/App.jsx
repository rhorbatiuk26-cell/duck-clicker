                  ...
                  <div key={friend.telegram_id} className="bg-gray-800 border border-gray-700 p-4 rounded-2xl relative overflow-hidden">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className={`flex-1 py-2 rounded-xl text-[10px] font-bold shadow-md transition-all ${friend.ref_reward_lvl3_claimed ? 'bg-gray-900 text-gray-600 border border-gray-800' :
                      ...
                      <button
                        ...
                        className={`flex-1 py-2 rounded-xl text-[10px] font-bold shadow-md transition-all ${friend.ref_reward_lvl5_claimed ? 'bg-gray-900 text-gray-600 border border-gray-800' :
